// Figma "Appearance = Lighten" for Unity UGUI under URP.
// result.rgb = max(src, dst) per-channel.
//
...
Shader "SoobakFigma2Unity/URP/BlendLighten"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define SOOBAK_BLEND_VARIANT_LIGHTEN
